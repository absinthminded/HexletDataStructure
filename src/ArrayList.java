...
public class ArrayList<T> implements List<T> {
    ...
    private class ElementsIterator implements ListIterator<T> {
        ...
        public T previous() {
            ...
            if (!hasPrevious()) throw new NoSuchElementException();//отрабатываем исключение
            //final int prevIndex = previousIndex();//сохраняем индекс возвращаемого элемента
            lastIndex = (--index);//можно и так: lastIndex = previousIndex();
            //естественно уменьшаем индекс, согласно документации.
            return ArrayList.this.m[lastIndex];
            // END
        }
