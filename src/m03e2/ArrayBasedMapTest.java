...
public class ArrayBasedMapTest {
    ...
    public void testGetOrDefault() {
        ...
        assertEquals("Not found", map.getOrDefault(getKeyNotInPopulatedMap(), new Student("Not found")).getUuid());
        assertEquals("0", map.getOrDefault("0", new Student("Not found")).getUuid());
        assertEquals("999", map.getOrDefault("999", new Student("Not found")).getUuid());
